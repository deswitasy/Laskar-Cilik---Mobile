        ...
        build: (context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Text('Predikat & Deskripsi'),
              pw.Text('Agama: ${s.nilaiAgama}'),
              pw.Text('Deskripsi: ${s.deskripsiAgama}'),
              pw.SizedBox(height: 6),
              pw.Text('STEM: ${s.nilaiSTEM}'),
              pw.Text('Deskripsi: ${s.deskripsiSTEM}'),
              pw.SizedBox(height: 6),
              pw.Text('Pancasila: ${s.nilaiPancasila}'),
              pw.Text('Deskripsi: ${s.deskripsiPancasila}'),
              pw.SizedBox(height: 6),
              pw.Text('Jati Diri: ${s.nilaiJatiDiri}'),
